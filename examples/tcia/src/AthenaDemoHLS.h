...
public:
    ...
    std::string runQuery1(std::string treatment);
    std::string runQuery2(int age_low, int age_high);
    std::string runQuery3(std::string name);
    std::string runQuery4(std::string patient);
    std::string runQuery5(std::string patient);
    std::string runQuery6(std::string patient);

    Jarvis::Graph* db(){return _db;}
